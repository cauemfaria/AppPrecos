...
import { Store, Settings, ScanBarcode, type LucideProps } from 'lucide-react';
    ...
    >
      ...
      >
        <div className="p-6" style={{ borderBottom: '1px solid var(--color-border)' }}>
          <div
            ...
            onClick={() => navigate('/')}
          >
            <div className="w-9 h-9 rounded-xl overflow-hidden flex items-center justify-center shrink-0" style={{ backgroundColor: 'color-mix(in srgb, var(--color-primary) 8%, var(--color-surface))' }}>
              <img
                src="/app-logo.png"
                alt="economiX Logo"
        ...
        <nav className="flex-1 px-3 py-4 space-y-1">
          <DesktopNavLink to="/" icon={<Store />} label="Início" exact />
          <DesktopNavLink to="/scanner" icon={<ScanBarcode />} label="Escanear" />
      ...
      >
        <div className="flex items-end justify-around px-2 pt-2 pb-6">
          <MobileNavLink to="/" icon={<Store />} label="Início" exact />
